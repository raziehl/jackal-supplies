...
const account_transaction_1 = require("./account.transaction");
...
let TransactionService = class TransactionService {
    ...
    createAccount(pass) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield lisk_service_1.lisknet.transactions.broadcast(tx)
                .then(data => {
    ...
    updateAccount(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield lisk_service_1.lisknet.transactions.broadcast(tx.toJSON())
    ...
    getAccount(userAddress) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const account = (yield lisk_service_1.lisknet.accounts.get({ address: userAddress })).data;
...
], TransactionService.prototype, "log", void 0);
